...
const NoteCard = ({note, updateNote, deleteNote}) => {
    return(
        <div className="animate-fade-in-up transition-all border-2 border-white p-4 rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] mt-2 mb-2 w-full max-w-xl mx-auto">
